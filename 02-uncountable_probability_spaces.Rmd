...
Additionally, $\forall i: \mathcal{C} \subseteq F_i$. So each $F_i$ can be written
...
<!-- ``` -->
```{exercise}
Prove that the following subsets of $(0,1]$ are Borel-measurable by finding their measure.
...
while their Lebesgue measures are infinity and one respectively.

...
\begin{align}
  Cov(X_i, X_j) &= E[X_i X_j] - E[X_i]E[X_j] \\
                &= - p_i p_j.
\end{align}
For arbitrary $n$, let $X_1 = \sum_{t = 1}^n X_{1t}$ and $X_2 = \sum_{l = 1}^n X_{2l}$, sums of intependent multinomial random variables with $n=1$. 
\begin{align}
...
$U \in [0,4]$ and $V \in [-\sqrt{U}, -\sqrt{U} + 1] \cup [\sqrt{U}, \sqrt{U} + 1]$. Let $X = \sqrt{U}$ and
$Y = V - \sqrt{U}$.

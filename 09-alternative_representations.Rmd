...
\begin{align}
  M_X(t) &= \int_{-\infty}^\infty e^{tx} \frac{1}{\sqrt{2 \pi \sigma_X^2}} e^{-\frac{(x - mu_X)^2}{2\sigma_X^2}} dx \\
         ...
         &= e^{-\frac{\mu_X^2 - \mu_X^2 - 2 \mu_X \sigma_X^2 t - \sigma_X^4 t^2}{2\sigma_X^2}} \\
         &= e^{\mu_X t + \frac{\sigma_X^2 t^2}{2}}. \\
\end{align}
The MGF of the sum is then
\begin{align}
  M_{X+Y}(t) &= e^{\mu_X t + \frac{\sigma_X^2 t^2}{2}} e^{\mu_Y t + \frac{\sigma_Y^2 t^2}{2}} \\
             &= e^{(\mu_X + \mu_Y)t + \frac{(\sigma_X^2 + \sigma_Y^2)t^2}{2}}.
\end{align}

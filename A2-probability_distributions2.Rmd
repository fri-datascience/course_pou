...
geometric | $p$ | $p(1-p)^k$ <br> \@ref(exr:geocdf) | $1 - (1-p)^{k + 1}$ <br> \@ref(exr:geocdf)| $\frac{1 - p}{p}$ <br> \@ref(exr:geoev)|
normal |$\mu$, $\sigma$ |$\frac{1}{\sqrt{2 \pi \sigma^2}} e^{\frac{(x - \mu)^2}{2 \sigma^2}}$ <br> \@ref(exr:normalpdf)| $\int_{-\infty}^x \frac{1}{\sqrt{2 \pi \sigma^2}} e^{\frac{(t - \mu)^2}{2 \sigma^2}} dt$ <br> \@ref(exr:normalpdf)| $\mu$ \@ref(exr:normev) | $\sigma$ \@ref(exr:normev)

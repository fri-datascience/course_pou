...
```{exercise}
Let $A$ and $B$ be events with probabilities $P(A) = \frac{5}{6}$ and
$P(B) = \frac{1}{4}$.
...
die, and $A$ corresponds to throwing 1 through 10 and $B$ corresponds to
...
```{exercise, label = Poispmf}
Something with Poisson.
